...
const DialogDeleteMonitoring = ({ props }: any) => {
  const handleDelete = async (e: { preventDefault: () => void }) => {
    e.preventDefault();
    try {
      const response = await postData("/laporan/delete", {
        props,
        tahun: "2024",
      });
  ...
  return (
    <Dialog>
      ...
      <DialogContent className="sm:max-w-[425px] bg-white">
        <Image
          src={"/images/cover/cover-delete.png"}
          width={500}
          height={550}
          alt="Delete Cover."
        />
...
export default DialogDeleteMonitoring;
